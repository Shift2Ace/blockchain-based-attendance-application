...
{ // Block
  ...
  "records": [ // list of records inside the block
      { // record 0
  ...
  "hash": "c4e0b8df46...199754d1ed" // hash taken from the contents of the block: sha256 (index + previousHash + timestamp + nonce + records) (64 bytes)
}
